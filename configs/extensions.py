# extensions, comment out what isnt needed.
...
file_extensions = {
    ...
    ".key": "Files containing cryptographic keys",
    ".cer": "Certificate files",
    ".crt": "More Certificate files",
    ".pfx": "PKCS#12 files",
    ".p12": "More PKCS#12 files",
    ".vbs": "VBScript files",
    ".psm1": "PowerShell module and data files",
    ".psd1": "More PowerShell module and data files",
    ".rdp": "Remote Desktop Protocol files",
    ".ost": "Outlook data files",
    ".pst":  "More Outlook data files",
